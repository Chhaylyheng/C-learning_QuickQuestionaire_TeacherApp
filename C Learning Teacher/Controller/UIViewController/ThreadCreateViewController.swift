...
//            self.present(importMenu, animated: true, completion: nil)
    ...
    func creatingThread() {
        Alamofire.request("https://kit.c-learning.jp/t/ajax/coop/make_a_thread", method: .post, parameters: ["ct":"c398223976", "sID":bbID, "c_no":"0", "mode":"pcreate", "ttID":"id1", "ttName":"Professor Kimhak", "fileID1": hval, "c_title": threadName, "c_text": threadDescrip ]).responseJSON {
            response in
            if response.result.isSuccess {
                _ = JSON(response.result.value!)
